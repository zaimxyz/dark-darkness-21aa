...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/dark-darkness-21aa)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dark-darkness-21aa
```

A live public deployment of this template is available at [https://dark-darkness-21aa.templates.workers.dev](https://dark-darkness-21aa.templates.workers.dev)
